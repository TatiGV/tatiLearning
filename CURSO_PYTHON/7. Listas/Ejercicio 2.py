...
lista[4] = lista[4] * 2  # tambien se puede : lista[4] *= 2
lista[7] = lista[7] * 2 # tambien se puede : lista[7] *= 2
lista[9] = lista[9] * 2 # tambien se puede : lista[9] *= 2

print('Este es el nuevo valor de la lista: {}'.format(lista))
